...
/**
  * @brief Lee una imagen segun el tipo
  *
  * @param nombre archivo a leer
  * @param imagen imagen huesped
  * @param tipo tipo de imagen a determinar
  * @return si ha tenido exito en la lectura.
  */                     
bool LeerImagen(const char *nombre, Imagen &imagen, TipoImagen &tipo);
/**
  * @brief Escribe una imagen segun el tipo
  *
  * @param nombre archivo a escribir (fich. salida)
  * @param imagen imagen a imprimir
  * @param tipo tipo de la imagen
  * @return si ha tenido exito en la escritura.
  */                     
bool EscribirImagen(const char *nombre, const Imagen &imagen, const TipoImagen &tipo);
